...
const ViewContractPage = () => {
    return <>
        ...
        {/*
        // @ts-ignore */}
        <React.Suspense fallback={<OutletContentLoading resource="services" />}><Await resolve={useLoaderData().servicesResponse} errorElement={<OutletContentError />}>{(servicesResponse) => (<Services records={servicesResponse.data} />)}</Await></React.Suspense>
        {/*
        // @ts-ignore */}
